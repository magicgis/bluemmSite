...
import cn.com.bluemoon.redpacket.config.ConfigInterface;

import com.bluemoon.business.pay.util.MD5Util;
//
//import com.weixin.wxap.util.MD5Util;
//import com.weixin.wxap.util.TenpayUtil;
import com.weixin.wxap.util.TenpayUtil;
...
public class RequestHandler {
	 ...
	 * 初始化函数。
	 */
	public void init(ConfigInterface config) {
		this.last_errcode = "0";
		this.Token = "token_";
		this.debugInfo = "";
