 ...
 */
package cn.com.bluemoon.jeesite.test.entity;
...
public class TestData extends DataEntity<TestData> {
	...
	private Date beginInDate2;		// 结束 加入日期
	private Date endInDate2;		// 结束 加入日期
	
	
	public Date getBeginInDate2() {
		return beginInDate2;
	}

	public void setBeginInDate2(Date beginInDate2) {
		this.beginInDate2 = beginInDate2;
	}

	public Date getEndInDate2() {
		return endInDate2;
	}

	public void setEndInDate2(Date endInDate2) {
		this.endInDate2 = endInDate2;
	}
