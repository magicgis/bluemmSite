...
public class UnifiedOrderRespond {
	...
	public String toString() {
		return "UnifiedOrderRespond [return_code=" + return_code
				...
				+ code_url + ", openid=" + openid + ", is_subscribe="
				+ is_subscribe + ", bank_type=" + bank_type + ", total_fee="
				+ total_fee + ", fee_type=" + fee_type + ", transaction_id="
				+ transaction_id + ", out_trade_no=" + out_trade_no
				+ ", attach=" + attach + ", time_end=" + time_end
				+ ", trade_state=" + trade_state + ", cash_fee=" + cash_fee
				+ "]";
	}
