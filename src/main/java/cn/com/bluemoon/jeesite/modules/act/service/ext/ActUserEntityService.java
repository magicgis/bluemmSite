 ...
 */
package cn.com.bluemoon.jeesite.modules.act.service.ext;
...
import cn.com.bluemoon.jeesite.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new cn.com.bluemoon.jeesite.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new cn.com.bluemoon.jeesite.modules.sys.entity.User(null, userId)))){
