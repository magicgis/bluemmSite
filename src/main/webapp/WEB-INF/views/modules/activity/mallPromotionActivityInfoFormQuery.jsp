...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/activity/mallPromotionActivityInfo/form?id=${mallPromotionActivityInfo.id}">优惠券活动查看</a></li>
	</ul><br/>
		...
		<fieldset title="活动逻辑">
			...
			<table style="width: 95%">
				<tr>
					...
					<td width="200px;">
						<div>
							<form:select path="coupon.sendCouponType" style="width:177px;" onchange="showType(this);">
					...
					<td id="theme" style="display:none;">	
						<strong>满足条件</strong>&nbsp;&nbsp;&nbsp;&nbsp;
						<form:select path="coupon.conditionType" style="width:177px;" onchange="changeTheme(this);">
