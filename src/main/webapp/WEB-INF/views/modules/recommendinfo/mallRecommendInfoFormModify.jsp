	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			if(url!=null&&url!=""){
				...
				li = "<li><img src=\""+url+"\" url=\""+url+"\" style=\"max-width:200px;max-height:200px;_height:200px;border:0;padding:3px;\">";
				li += "<a href=\"javascript:\" onclick=\"pictureFirstDel(this);\">×</a></li>";
			...
			if(url!=null&&url!=""){
				...
				li = "<li><img src=\""+url+"\" url=\""+url+"\" style=\"max-width:200px;max-height:200px;_height:200px;border:0;padding:3px;\">";
				li += "<a href=\"javascript:\" onclick=\"pictureSecondDel(this);\">×</a></li>";
...
<body>
	...
	<form:form id="inputForm" modelAttribute="mallRecommendInfo" action="${ctx}/recommendinfo/mallRecommendInfo/update" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<fieldset title="编辑推荐码">
			<legend>编辑推荐码</legend>
			<table style="width: 95%;">
				...
				<tr>
					<td align='center'><sys:ckfinder input="pictureFirst" type="images" uploadPath="/recommendPhoto" 
							selectMultiple="false" maxWidth="200" maxHeight="200" />
		...
		<div class="form-actions">
			...
			<input id="btnCancel" class="btn" type="button" value="返 回" onclick="goHome()"/>
		</div>
	</form:form>
<script type="text/javascript">
function goHome(){
	var url = '${ctx}/recommendinfo/mallRecommendInfo/';
