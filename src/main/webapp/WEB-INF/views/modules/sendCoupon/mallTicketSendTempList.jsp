...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/mallticketsendtemp/mallTicketSendTemp/">推券活动授权管理列表</a></li>
		<shiro:hasPermission name="mallticketsendtemp:mallTicketSendTemp:edit"><li><a href="${ctx}/mallticketsendtemp/mallTicketSendTemp/form">推券活动授权新增</a></li></shiro:hasPermission>
	</ul>
