...
// 	}
	...
	function setLevel(levelJson,tableId){
		...
		newStr += "<td width='100px;' align='center'><input type='hidden' value='"+levelJson+"'><a href='javascript:' >删除</a></td>";
		newStr += "</tr>";
		if(partItemIndex!=1){
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/activityMJS/mallPromotionActivityInfo/form?id=${mallPromotionActivityInfo.id}">满就送活动<shiro:hasPermission name="activityMJS:mallPromotionActivityInfo:edit">编辑</shiro:hasPermission><shiro:lacksPermission name="activityMJS:mallPromotionActivityInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="mallPromotionActivityInfo" action="${ctx}/activityMJS/mallPromotionActivityInfo/update" method="post" class="form-horizontal">
			...
			<table style="width: 95%;">
				...
				<tr>
					...
					<td name="fixedTime" class="fixedTime"><input id="startTime" name="startTime" type="text" maxlength="20" class="input-medium Wdate "
						value="<fmt:formatDate value="${mallPromotionActivityInfo.startTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" readonly/>
						<span class="help-inline"><font color="red">*</font></span></td>
				...
				<tr>
					...
					<td colspan="7">
						<form:textarea path="activityDesc" cols="1000" rows="3" class="input-xxlarge" maxlength="250"/>
		...
		<fieldset title="使用逻辑">
			...
			<table style="width: 95%">
				<tr>
					...
					<td align="left"><form:select path="condition" class="input-medium" onchange="changeTheme(this);" disabled="true">
