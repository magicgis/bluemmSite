...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var cb = '${mallPromotionActivityInfo.activityItemType}';
		if(cb == 'lmited_discount'){
			$("#lmited_discount").attr('checked','checked');
			$("#iValue").html("折扣力度（折）");
		}else if(cb == 'limited_price'){
			$("#limited_price").attr('checked','checked');
			$("#iValue").html("降价金额（元）");
		}
		var rt = '${mallPromotionActivityInfo.restrictionType}';
		var rv = '${mallPromotionActivityInfo.restrictionValue}';
		if(rt == 'not_restriction'){
			$("#not_restriction").attr('checked','checked');
		}else if(rt == 'promotion_restriction'){
			$("#promotion_restriction").attr('checked','checked');
			$("#s1").val(rv);
		}
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#">商品活动<shiro:hasPermission name="activityItem:mallPromotionActivityInfo:edit">查看</shiro:hasPermission><shiro:lacksPermission name="activityItem:mallPromotionActivityInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForms" modelAttribute="mallPromotionActivityInfo" action="${ctx}/activityItem/mallPromotionActivityInfo/update" method="post" class="form-horizontal">
		...
		<fieldset title="基本信息">
			...
			<table style="width: 95%;">
				...
				<tr>
					...
					<td><form:select path="activityTheme" onchange="changecouponType(this);" style="width:177px;" disabled="true">
					...
					<td><form:input path="activitySName" class="input-medium" placeholder='最多8个字' readonly="true"/>
				...
				<tr>
					...
					<td colspan="3"><form:input path="activityName" class="input-xxlarge" placeholder='最多20个字' readonly="true"/>
					<span class="help-inline"><font color="red">*</font></span></td>
				</tr>
				<tr>
					<td colspan="8">
				...
				<tr>
					...
					<td colspan="7">
						<form:textarea path="activityDesc" cols="1000" rows="3" class="input-xxlarge" readonly="true"/>
			...
			<table style="width: 95%">
				<tr>
					...
					<td align="left" width="10%">
						<input type="radio" name="aType"  value="limited_price" id="limited_price" disabled="true"/><strong>限时降价</strong>
					</td>
					<td align="left" width="20%">
						<input type="radio" name="aType"  value="lmited_discount" id="lmited_discount" disabled="true"/><strong>限时折扣</strong>
					</td>
					<td align="left" id="iType">
						<span><strong  id="iValue">&nbsp;</strong></span><span class="help-inline"><font color="white" id="fcol">*</font></span>
						<input type="text" value="${itemValue} " class="input-medium" readonly/>
						
					</td>
				</tr>
				<tr>
					<td width="10%"><strong>限购</strong><span class="help-inline"><font color="red">*</font></span></td>
					<td align="left" width="10%"><input type="radio" name="rType" value="not_restriction" id="not_restriction" disabled="disabled"/><strong>不限购</strong></td>
					<td align="left" width="20%"><input type="radio" name="rType" value="promotion_restriction" id="promotion_restriction" disabled="disabled"/><strong>优惠限购</strong>&nbsp;<input type="text" class="spinner" readonly="true" id="s1" value="${mallPromotionActivityInfo.restrictionValue}"/>
					<!-- <td align="left" width="20%"><input type="radio" name="rType" value="number_restriction" onclick="changRType(2)"/><strong>数量限购</strong>&nbsp;<input type="text" class="spinner" readonly="true"/> -->
					</td>
				</tr>
			</table>
		</fieldset>
