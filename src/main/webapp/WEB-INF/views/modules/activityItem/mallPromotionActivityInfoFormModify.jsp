...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if(rt == 'not_restriction'){
			...
			$("#s1").val(rv);
			$("#s2").val(1);
		}else if(rt =='number_restriction'){
			$("#number_restriction").attr('checked','checked');
			$("#s1").val(1);
			$("#s2").val(rv);
		}
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#">商品活动<shiro:hasPermission name="activityItem:mallPromotionActivityInfo:edit">编辑</shiro:hasPermission><shiro:lacksPermission name="activityItem:mallPromotionActivityInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
		...
		<fieldset title="活动逻辑">
			...
			<table style="width: 95%">
				...
				<tr>
					...
					<%-- <td align="left" width="20%"><input type="radio" name="rType" value="number_restriction" onclick="changRType(2)" disabled="disabled"/><strong>数量限购</strong>&nbsp;<input type="text" class="spinner" readonly="true" id="s2" value="${mallPromotionActivityInfo.restrictionValue}"/> --%>
					</td>
				</tr>
			</table>
		</fieldset>
